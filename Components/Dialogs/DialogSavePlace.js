...
const DialogSavePlace = ({visible, setVisible, setPoint, point, coor}) => {
        ...
        if (category !== 'Select Category') {
          if (time !== undefined) {
            if (time2 !== undefined) {
              ...
              data.push(geo);
              setPoint(data);
              setPlace({...place, name: '', address: '', detail: ''});
              setCategory('Select Category');
              setVisible(false);
              segmentContext.setSeg(0);
              dialogContext.setData(true);
              setTimeout(() => {
              ...
              setError({
                ...error,
                status: true,
                close: 'time closed is required',
              });
            }
          } else {
            setError({...error, status: true, open: 'time open is required'});
          }
        } else {
          setError({...error, status: true, category: 'category is required'});
        }
      } else {
        setError({...error, status: true, address: 'address is required'});
      }
    } else {
      setError({...error, status: true, name: 'name is required'});
    }
  };
  ...
  const data = [
    ...
    {name: 'Restaurant', image: Restuarant, color: '#ec5960'},
            ...
            <View
              ...
              <View
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View
                      ...
                      <ModalDropdown
                        ...
                        onSelect={(index, value) => {
                          ...
                          setError({...error, category: '', status: false});
                        }}
                        options={data}
                        style={{
                          width: '90%',
                  ...
                  />
                  {error.status && error.category !== 'Select Category' ? (
                    <Text
                      style={{
                        fontFamily: 'AvenirLTStd-Book',
                        color: 'red',
                  ...
                  <Item stackedLabel style={{marginBottom: 20}}>
                    ...
                    <Input
                      ...
                      onChangeText={text => {
                        ...
                        setError({...error, address: '', status: false});
                      }}
                      style={{
                        fontFamily: 'AvenirLTStd-Book',
                        borderBottomWidth: 1.5,
                  ...
                  <View
                    ...
                    <View style={{width: '48%'}}>
                          ...
                          <Left>
                            <TimePicker
                              ...
                              onChange={e => {
                                console.log(e);
                                setTime(e);
                                setError({...error, open: '', status: false});
                              }}
                              style={{
                                color: '#0f2e47',
                                fontFamily: 'AvenirLTStd-Book',
                      ...
                      {error.status && error.open !== undefined ? (
                        <Text
                          style={{
                            fontFamily: 'AvenirLTStd-Book',
                            color: 'red',
                    ...
                    <View style={{width: '48%'}}>
                      ...
                      <View
                        ...
                        {error.status && error.close !== undefined ? (
                          <Text
                            style={{
                              fontFamily: 'AvenirLTStd-Book',
                              color: 'red',
...
export default DialogSavePlace;
